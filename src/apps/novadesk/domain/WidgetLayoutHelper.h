...
public:
   ...
   */
  static void SetLayoutConfig(Widget &widget, const std::wstring &id,
   ...
   */
  static bool TryGetLayoutConfig(const Widget &widget, const std::wstring &id,
                                 LayoutConfig &config);
   ...
   * @param newContainerId ID of the new container (empty string to remove from
   * container)
   */
  static void UpdateContainerForElement(Widget &widget, Element *element,
   ...
   */
  static bool WouldCreateContainerCycle(const Element *element,
   ...
   */
  static bool HitTestContainerChildren(Element *container, int x, int y,
                                       Element *&outElement);
   ...
   */
  static std::unordered_map<std::wstring, LayoutConfig> &
  GetLayoutConfigs(Widget &widget);
  static const std::unordered_map<std::wstring, LayoutConfig> &
  GetLayoutConfigs(const Widget &widget);

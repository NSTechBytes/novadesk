...
EllipseShape::EllipseShape(const std::wstring &id, int x, int y, int width,
                           int height)
...
bool EllipseShape::CreateGeometry(
  ...
  if (FAILED(factory->CreateEllipseGeometry(ellipse,
                                            ellipseGeometry.GetAddressOf())))
    return false;

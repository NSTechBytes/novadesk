...
namespace novadesk::scripting::quickjs::parser
{
    struct WidgetWindowOptions
    {
        ...
        bool backgroundSizeIsExplicit = false;
        float backgroundSizeWidth = 0.0f;
        float backgroundSizeHeight = 0.0f;
        bool backgroundSizeHasWidth = false;
        bool backgroundSizeHasHeight = false;
        std::wstring backgroundSize = L"cover";
        bool hasBackgroundSize = false;

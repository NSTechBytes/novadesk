...
void ParseImageOptions(JSContext *ctx, JSValueConst obj, ImageOptions &options,
                       const std::wstring &baseDir = L"");
void ParseTextOptions(JSContext *ctx, JSValueConst obj, TextOptions &options,
                      const std::wstring &baseDir = L"");
void ParseButtonOptions(JSContext *ctx, JSValueConst obj,
                        ButtonOptions &options,
                        const std::wstring &baseDir = L"");
void ParseBitmapOptions(JSContext *ctx, JSValueConst obj,
                        BitmapOptions &options,
                        const std::wstring &baseDir = L"");
void ParseRotatorOptions(JSContext *ctx, JSValueConst obj,
...
void ParseRoundLineOptions(JSContext *ctx, JSValueConst obj,
                           ...
                           const std::wstring &baseDir = L"");
void ParseShapeOptions(JSContext *ctx, JSValueConst obj, ShapeOptions &options,
                       const std::wstring &baseDir = L"");
...
void ParseAreaGraphOptions(JSContext *ctx, JSValueConst obj,
                           ...
                           const std::wstring &baseDir = L"");
void ParseInputBoxOptions(JSContext *ctx, JSValueConst obj,
...
void ApplyRotatorOptions(RotatorElement *element,
                         const RotatorOptions &options);
...
void ApplyInputBoxOptions(InputBoxElement *element,
...
void PreFillLayoutBoxOptions(
    LayoutBoxOptions &options, ElementLayoutBox *element,
    const std::wstring *direction = nullptr, const int *gap = nullptr,
    const std::wstring *align = nullptr, const std::wstring *justify = nullptr,
    const int *paddingLeft = nullptr, const int *paddingTop = nullptr,
    const int *paddingRight = nullptr, const int *paddingBottom = nullptr,
...
void ParseGeneralImageOptions(JSContext *ctx, JSValueConst obj,
                              ...
                              const std::wstring &baseDir = L"");
void ApplyGeneralImageOptions(GeneralImage *image,

...
int JsNowPlayingPlay(novadesk_context ctx) {
  GetController().QueueAction(MediaAction::Play);
  g_Host->PushBool(ctx, 1);
  return 1;
}
int JsNowPlayingPause(novadesk_context ctx) {
  GetController().QueueAction(MediaAction::Pause);
  g_Host->PushBool(ctx, 1);
  return 1;
}
int JsNowPlayingPlayPause(novadesk_context ctx) {
  GetController().QueueAction(MediaAction::PlayPause);
  g_Host->PushBool(ctx, 1);
  return 1;
}
int JsNowPlayingStop(novadesk_context ctx) {
  GetController().QueueAction(MediaAction::Stop);
  g_Host->PushBool(ctx, 1);
  return 1;
}
int JsNowPlayingNext(novadesk_context ctx) {
  GetController().QueueAction(MediaAction::Next);
  g_Host->PushBool(ctx, 1);
  return 1;
}
int JsNowPlayingPrevious(novadesk_context ctx) {
  GetController().QueueAction(MediaAction::Previous);
  g_Host->PushBool(ctx, 1);
  return 1;
}
...
NOVADESK_ADDON_UNLOAD() { g_Controller.reset(); }

...
ui.addText({
    ...
    cursorsDir: "../assets",
    mouseEventCursorName: "cur1164.ani",
...
console.log("default_hand.mouseEventCursor=" + ui.getElementProperty("default_hand", "mouseEventCursor"));
console.log("cursor_off.mouseEventCursor=" + ui.getElementProperty("cursor_off", "mouseEventCursor"));
console.log("busy_cursor.mouseEventCursorName=" + ui.getElementProperty("busy_cursor", "mouseEventCursorName"));
console.log("custom_ani_cursor.cursorsDir=" + ui.getElementProperty("custom_ani_cursor", "cursorsDir"));
console.log("custom_cur_cursor.mouseEventCursorName=" + ui.getElementProperty("custom_cur_cursor", "mouseEventCursorName"));

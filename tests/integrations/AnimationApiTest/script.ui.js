...
expectEq("initial x", ui.getElementProperty("animBox", "x"), 20);
expectEq("initial y", ui.getElementProperty("animBox", "y"), 40);
...
ipcRenderer.on("animation:test:end", () => {
  ...
  expectEq("end x", endX, 260);
  expectEq("end y", endY, 140);
  expectEq("end contentWidth", endW, 180);
  expectEq("end contentHeight", endH, 90);
  expectBetween("end rotate", endR, 14.5, 15.5);

  // second element should be in-flight at this point (500ms duration, started at t=0)
...
ipcRenderer.on("animation:test:extra-end", () => {
  ...
  expectEq("replaced end x", x, 120);
  expectEq("replaced end y", y, 180);
  ...
  expectEq("animBox2 end x", ui.getElementProperty("animBox2", "x"), 300);
  expectEq("animBox2 end y", ui.getElementProperty("animBox2", "y"), 230);
